...
const heroData = [
    { img: '/car1.jpg', top: 'LIST YOUR VEHICLE', bottom: 'START YOUR SALES JOURNEY' },
    { img: '/car2.jpg', top: 'LIST YOUR VEHICLE', bottom: 'START YOUR SALES JOURNEY' },
    { img: '/car3.jpg', top: 'LIST YOUR VEHICLE', bottom: 'START YOUR SALES JOURNEY' },
    { img: '/car4.jpg', top: 'LIST YOUR VEHICLE', bottom: 'START YOUR SALES JOURNEY' },
];
