...
const heroData = [
  ...
  { img: '/car2.jpg', top: 'YOUR BEST', mid: 'CAR CHOOSING', bottom: 'EXPERIENCE' },
  { img: '/car3.jpg', top: 'YOUR BEST', mid: 'CAR RENTAL', bottom: 'EXPERIENCE' },
  { img: '/car4.jpg', top: 'YOUR BEST', mid: 'CAR LEASING', bottom: 'EXPERIENCE' },
];
...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-[88vh] w-full overflow-hidden bg-black flex flex-col">
      {/* Hero Images Layer */}
      {heroData.map((data, i) => (
        <div
          key={i}
      ...
      <div 
        key={index} 
        className={`relative z-10 flex-grow flex flex-col items-center justify-center text-white text-center transition-opacity duration-500 px-4 ${isLeaving ? 'opacity-0' : 'opacity-100'}`}
      >
